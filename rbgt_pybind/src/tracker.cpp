...
std::vector<std::shared_ptr<Camera>> Tracker::camera_ptrs() const {
  return camera_ptrs_;
}

std::vector<std::shared_ptr<OcclusionMaskRenderer>> Tracker::occlusion_mask_renderer_ptrs() const {
  return occlusion_mask_renderer_ptrs_;
}
